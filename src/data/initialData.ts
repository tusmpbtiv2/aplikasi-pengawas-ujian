...
export const INITIAL_SETTINGS: Settings = {
  ...
  principal_nip: '196805121994031005',
  committee_chairman_name: 'Budi Santoso, S.Pd.',
  committee_chairman_nip: '197508142000031002',
  committee_secretary_name: 'Siti Rahmawati, S.Pd.',
  ...
  app_name: 'Sistem Manajemen Ujian SMP Bhinneka',
  theme: 'blue',
...
export const INITIAL_PROJECTS: ExamProject[] = [
  {
    id: 'proj-pas-genap-2025',
    name: 'Penilaian Akhir Semester (PAS) Genap 2024/2025',
    academic_year: '2024/2025',
    semester: 'Genap',
    exam_name: 'Penilaian Akhir Semester (PAS) Genap',
    description: 'Kegiatan Penilaian Akhir Semester genap untuk seluruh jenjang kelas 7, 8, dan 9.',
  ...
  {
    id: 'proj-asaj-2025',
    name: 'Asesmen Sumatif Akhir Jenjang (ASAJ) Kelas 9 2024/2025',
    academic_year: '2024/2025',
    semester: 'Genap',
    exam_name: 'Asesmen Sumatif Akhir Jenjang (ASAJ)',
    description: 'Ujian Kelulusan Tingkat Satuan Pendidikan untuk Peserta Didik Kelas IX.',
    created_at: '2025-02-01T08:00:00Z',
    is_active: false,
    exam_schedules: INITIAL_EXAM_SCHEDULES.slice(0, 6),
    invigilator_schedules: INITIAL_INVIGILATOR_SCHEDULES.slice(0, 270),
    settings_override: {
      exam_name: 'Asesmen Sumatif Akhir Jenjang (ASAJ)',
      academic_year: '2024/2025',
      semester: 'Genap',
